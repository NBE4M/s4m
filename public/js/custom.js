    function CheckBoth() {
        if (document.getElementById("bothsame").checked == true) {
            var Name = document.getElementById("agency_name").value;
            var Designation = document.getElementById("agency_des").value;
            var Office_Address = document.getElementById("agency_org").value;
             var tw = document.getElementById("atw").value;
            var Email = document.getElementById("email").value;
            var Mobile_number = document.getElementById("mobile").value;
            document.getElementById("a_name").value = Name;
            document.getElementById("a_des").value = Designation;
            document.getElementById("a_org").value = Office_Address;
             document.getElementById("aatw").value = tw;
            document.getElementById("aemail").value = Email;
            document.getElementById("amobile").value = Mobile_number;
        }
        else {
