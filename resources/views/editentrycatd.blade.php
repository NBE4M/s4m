 ...
 <div class="container">
        ...
        <div class="entry-form">   
            ...
            <div class="panel-body">
               <form class="form-horizontal" role="form" method="POST" action="{{ url('/entry').'/'.$entry->id }}">
        {{ csrf_field() }}
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                                      <label>Company Activity<span class="mandat">*</span><br>
                                          <small>(Please choose the field carefully as it will determine your chances to win Hall of Fame Awards)</small><br>
                                            <small><span class="pnote">NOTE</span>: <a href="https://e4mevents.com/idma-2018/rules" target="blank">Refer to e4m Indian Digital media Awards 2018 Rules & Regulations</a> before filling this form</small>
                    </label>
                      <select class="selectcountry" required name="comactivity">
                                          <option value="{{ $entry->company_activity }}">{{ $entry->company_activity }}</option>
