                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="hidepanel1" class="panel panel-primary">
                                ...
                                <form files="true" class="dropzone" id="image-upload" action="{{URL('/admin/dropzoneUploadgallery')}}" method="post"  enctype="multipart/form-data">
                                {{csrf_field()}}
                        ...
                        <!--basic form 2 starts-->
                                ...
                                @foreach($data as $k)
                                <a class="lightbox">
                                <img src="{{ url('/') }}/public/img/gallery/{{$k}}" class="img-thumbnail"  width="100" height="100"> </a> 
                                @endforeach
                                </div>
